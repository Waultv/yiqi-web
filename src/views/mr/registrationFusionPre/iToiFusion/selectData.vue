<template>
  <div class="patient-info">
    ...
    <el-row class="info-row">
      ...
      <el-col :span="6" class="back-button">
        <!-- 返回按钮 -->
    ...
    <el-row class="ultrasound-images">
      <el-col :span="8">
        ...
        <div class="image-option" v-for="(image, index) in ultrasoundImages" :key="index">
          ...
          <img src='./image1.jpg' alt="ultrasound image"/>
        </div>
      </el-col>

      <el-col :span="8">
        <div class="info-label">MRI图像</div>
        <div class="image-option" v-for="(image, index) in ultrasoundImages" :key="index">
          <el-radio v-model="selectedImageIndex" :label="index">{{ '图像 ' + (index + 1) }}</el-radio>
          <img src='./image1.jpg' alt="ultrasound image"/>
        </div>
    ...
    <el-row class="result-display">
      <el-button type="success" class="export-button" @click="exportTable">开始融合</el-button>
